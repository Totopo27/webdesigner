import type { Screen1789421839297ViewItem } from "./types.js";

export const mockScreen1789421839297ViewData = {
  ...
  ] as const satisfies ReadonlyArray<Screen1789421839297ViewItem>,
};
