import type { Screenlocal1789410914774ViewItem } from "./types.js";

export const mockScreenlocal1789410914774ViewData = {
  ...
  ] as const satisfies ReadonlyArray<Screenlocal1789410914774ViewItem>,
};
