import type { Screenlocal1789420218826ViewItem } from "./types.js";

export const mockScreenlocal1789420218826ViewData = {
  ...
  ] as const satisfies ReadonlyArray<Screenlocal1789420218826ViewItem>,
};
